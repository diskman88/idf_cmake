...
function(__build_init idf_path)
    ...
    file(GLOB component_dirs ${idf_path}/components/*) # 获取components下所有文件列表，存入component_dirs
    foreach(component_dir ${component_dirs})
        get_filename_component(component_dir ${component_dir} ABSOLUTE) # 获取绝对路径
        __component_dir_quick_check(is_component ${component_dir})
        if(is_component) # 路径存在
            __component_add(${component_dir} ${prefix}) # commonnents.cmake中
        endif()
    endforeach()
